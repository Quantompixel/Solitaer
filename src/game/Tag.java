...
public enum Tag {
    ...
    RESET("-fx-background-radius: 10%;" + "-fx-font-size: 15pt;" + "-fx-background-color:#6B917E;"),
    UNDO("-fx-background-radius: 10%;" + "-fx-font-size: 15pt;" + "-fx-background-color:#6B917E;"),
    REDO("-fx-background-radius: 10%;" + "-fx-font-size: 15pt;" + "-fx-background-color:#6B917E;");
